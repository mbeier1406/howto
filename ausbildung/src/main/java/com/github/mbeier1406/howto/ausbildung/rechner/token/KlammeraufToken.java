...
import static com.github.mbeier1406.howto.ausbildung.rechner.Lexer.STD_TOKEN_HASHCODES.KLAMMERAUF_TOKEN_HASHCODE;
...
/**
 * Das Token für die öffnende Klammer.
 */
@Token
public class KlammeraufToken implements TokenInterface {
	...
	@Override
	public int hashCode() {
		return KLAMMERAUF_TOKEN_HASHCODE.ordinal(); // gibt nur ein (
	}
